...
class _CajaScreenState extends State<CajaScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final totalEntregado = (caja?['total_entregado'] as num?)?.toDouble();
    ...
    final pendientePorEntregar = base + cobrado - (totalEntregado ?? 0);
            ...
            pagos.isEmpty
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (_, i) {
                      final p = pagos[i];
                      final mon =
                          (p['monto_pagado'] as num?)?.toDouble() ?? 0;
                      final nom =
                          p['prestamos']?['clientes']?['nombre'] ?? 'Cliente';
                      final hora = DateFormat('hh:mm a').format(
                        DateTime.parse(p['fecha_pago']).toLocal(),
                      );
